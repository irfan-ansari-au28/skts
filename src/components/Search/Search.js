...
const Search = () => {
  ...
  return (
    <>
      { alertOpen && <Alert onClose={handleClose} severity="success" sx={{ width: '100%', backgroundColor: '#E6F3E5', color: 'black', border:'1px solid #4EAF51' }}>
          Your documents are being downloaded. Please check the download page for status updates.
        </Alert>}
